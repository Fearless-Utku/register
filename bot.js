...
client.on("guildMemberAdd", member => {  
  ...
  if (kurulus > 1296000000) kontrol = '✅'
  moment.locale("tr");
  kanal.send("<:tac:781082440318976030> Sunucumuza Hoş Geldin ! <@" + member + "> \n\n<:tac:781082440318976030> Hesabın "+ gecen +" Önce Oluşturulmuş "+kontrol+" \n\n<:tac:781082440318976030> Sunucu kurallarımız <#780894652408659979> kanalında belirtilmiştir. Unutma sunucu içerisinde ki ceza işlemlerin kuralları okuduğunu varsayarak gerçekleştirilecek. \n\n<:tac:781082440318976030> Seninle beraber " + member.guild.memberCount + " kişi olduk. Tagımızı alarak bizlere destek olabilirsin. Kayıt olmak için teyit odalarına girip ses teyit vermen gerekiyor <@&779999144566849547> seninle ilgilenecektir ! İyi eğlenceler.")
  .setImage("https://cdn.discordapp.com/attachments/780909887538462730/791956373713321995/ezgif-4-e33e155f99d6.gif")
  });
...
client.on("guildMemberAdd", member => {
  member.roles.add('779999655428882432'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
