...
if(!message.member.roles.cache.some(r => ['779999144566849547', '780159285312749619'].includes(r.id)) && (!message.member.hasPermission("779999144566849547")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
