...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ['779999144566849547', '780159285312749619'].includes(r.id)) && (!message.member.hasPermission("779999144566849547")))
 ...
 if(!kullanıcı) {
    ...
    .setDescription(`<:imek:781086639291236402> Toplam Kayıtlar:  \`${kayıtlar}\`
    <:imek:781086639291236402> Toplam Erkek Kayıtların: \`${erkek}\`
    <:imek:781086639291236402> Toplam Kadın Kayıtların: \`${kadın}\`
    `)
    .setColor("0x2f3136")
